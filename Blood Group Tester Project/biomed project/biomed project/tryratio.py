...
directory_template = "F:\\biomed project"
...
# =============================================================================
    ...
    if(ratio < 0.15):
        if(loadfilename == "A.jpg"):
            classification_string = classification_string + "A"
        elif (loadfilename == "B.jpg"):
            classification_string = classification_string + "B"
    if(loadfilename == "Rh.jpg"):
        if(ratio <= 0.15):
            classification_string = classification_string + "+"
        elif (ratio > 0.15):
            classification_string = classification_string + "-"

if (classification_string == "+" or classification_string == "-"):
    classification_string = "O" + classification_string + ".jpg"
else :
    classification_string = classification_string + ".jpg"    
