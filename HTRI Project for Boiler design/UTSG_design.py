...
Tho = 555#ABT(300)  #Outlet Temperature of Reactor Coolant
...
Ci = prop.IAPWS97(**{'P': Pci, 'T': Tci, 'h': None, 'l': 0.0, 's': None, 'v': None, 'x': xci}) #Single-phase
Co = prop.IAPWS97(T = Tco , x = xco)    #Two-phase
Hi = prop.IAPWS97(**{'P': Phi, 'T': Thi, 'h': None, 'l': 0.0, 's': None, 'v': None, 'x': xh})
Ho = prop.IAPWS97(**{'P': Phi, 'T': Tho, 'h': None, 'l': 0.0, 's': None, 'v': None, 'x': xh})

#%% MASS FLOW RATE CALCULATION FROM Q' = m'x del_h
mf_shellside = Power / (((Co.Vapor.h*xco) + ((1- xco)*Co.Liquid.h)) - Ci.Liquid.h)
